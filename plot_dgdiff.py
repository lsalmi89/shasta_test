...
dir_iter1 = '/work/shasta2/lsalmi/SourceStacking.New/PAVA/Standard/Iter_2/'
...
data_diff = np.subtract(data_d,data_g)
...
dataiter_diff = np.subtract(data_d, dataiter_g)
...
dataiter2_diff = np.subtract(data_d, dataiter2_g)
...
plt.subplot(3,1,1)
plt.plot(t, data_diff, 'red', lw = 2)
plt.ylabel('Acceleration (m/s^2)', fontsize='18', fontweight='bold')
plt.yticks(fontsize='16')
plt.xticks(fontsize='16')
plt.title(st1+' difference of observed vs synthetic, 1D prediction', fontsize='18', fontweight='bold')
plt.ylim(-5e-8, 5e-8)
plt.legend(loc=1)

# Plot observed and synthetic waveforms on same figure for first iteration
plt.subplot(3,1,2)
plt.plot(t, dataiter_diff, 'red', lw = 2)
plt.yticks(fontsize='16')
plt.xticks(fontsize='16')
plt.ylabel('Acceleration (m/s^2)', fontsize='18', fontweight='bold')
plt.title(st1+' difference of observed vs synthetic, second iteration', fontsize='18', fontweight='bold')
plt.ylim(-5e-8, 5e-8)
plt.legend(loc=1)

# Plot observed and synthetic waveforms on same figure for second iteration
plt.subplot(3,1,3)
plt.plot(t, dataiter2_diff, 'red', lw = 2)
plt.ylabel('Acceleration (m/s^2)', fontsize='18', fontweight='bold')
plt.yticks(fontsize='16')
plt.xticks(fontsize='16')
plt.xlabel('Time (s)', fontsize='18', fontweight='bold')
plt.title(st1+' difference of observed vs synthetic, fifth iteration', fontsize='18', fontweight='bold')
plt.ylim(-5e-8, 5e-8)
plt.legend(loc=1)
...
plt.savefig(st1+'_diff.png' , dpi=120, pad_inches=0)
plt.show()
